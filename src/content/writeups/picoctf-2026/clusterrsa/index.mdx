...
1. **Factor the modulus `n`**: Since each prime factor is relatively small, we can use services like [factordb.com](https://factordb.com) or tools like `sympy.factorint()`, `yafu`, or `msieve` to factor `n`.
